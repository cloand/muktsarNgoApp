...
import { getEligibilityDisplayInfo } from '../utils/eligibilityUtils';
...
const AdminDashboardScreen = ({ navigation }) => {
  ...
  const renderDonorItem = ({ item }) => {
    const eligibilityInfo = getEligibilityDisplayInfo(item.lastDonationDate);
    ...
    return (
      <Card style={styles.donorCard} key={item.id}>
            ...
            <View style={styles.donorBadges}>
              ...
              <Chip
                ...
                style={[
                  ...
                  {
                    borderColor: eligibilityInfo.color,
                    backgroundColor: eligibilityInfo.isEligible ? '#E8F5E8' : '#FFEBEE'
                  }
                ]}
                textStyle={{ color: eligibilityInfo.color }}
              >
        ...
        <View style={styles.donorDetails}>
          ...
          <Text style={[styles.donorDetailText, { color: eligibilityInfo.color, fontWeight: '500' }]}>
